...
export class DataService {
  ...
  private driverUrl = `https://dmrs.software/api/v1/driver`;
  private vehicleUrl = `https://dmrs.software/api/v1/vehicle`;
  private totalEventsUrl = `https://dmrs.software/api/v1/analysis/totalEvents`;
